...
//edit by Aven, Make Design Interact, New Media& Communication, WPP, SADA
...
void setup() 
{
  ...
  randomSeed(analogRead(5)); //Added to generate "more randomness" with the randomArray for the output function
